...
// const orgLocation = document.getElementById("orgLocation");
...
//   organizer = users.find((u) => String(u._id || u.id) === String(id));
//   orgName.textContent = organizer?.fullName || organizer?.name || organizer?.organizationName || "Organizer";
//   orgEmail.textContent = organizer?.email || "—";
//   orgLocation.textContent = getLocationText(organizer);
// }

// document.getElementById("approveBtn").addEventListener("click", async () => {
//   try {
//     await apiRequest(`/admin/organizers/${id}/approve`, { method: "PATCH" });
//     feedback.textContent = "Organizer approved successfully.";
//     feedback.className = "success-message";
//     setTimeout(() => { window.location.href = ROUTES.adminVerificationQueue; }, 700);
//   } catch (err) {
//     feedback.textContent = err.message || "Failed to approve organizer.";
...
//   try {
//     await apiRequest(`/admin/organizers/${id}/reject`, { method: "PATCH" });
//     feedback.textContent = "Organizer rejected successfully.";
//     feedback.className = "success-message";
//     setTimeout(() => { window.location.href = ROUTES.adminVerificationQueue; }, 700);
//   } catch (err) {
//     feedback.textContent = err.message || "Failed to reject organizer.";
//     feedback.className = "form-error";
//   }
// });
